...
function main(;
    ...
    for ifreq in nfreq0:nfreq1
        ...
        if verbose
            @printf(
                "[d] ref=%2d f=%3d in=%+8.3e out=%+8.3e disk=%+8.3e ring=%+8.3e bal=%+8.3e max-cin=%+8.3e \n",
                nref,
                freq,
                I_in[1],
                I_out[1],
        ...
        if verbose
            @printf(
                "[r] ref=%2d f=%3d in=%+8.3e out=%+8.3e disk=%+8.3e ring=%+8.3e bal=%+8.3e max-cin=%+8.3e \n",
                nref,
                freq,
                I_in[1],
                I_out[1],
        ...
        if verbose
            @printf(
                "[c] ref=%2d f=%3d in=%+8.3e out=%+8.3e disk=%+8.3e ring=%+8.3e bal=%+8.3e max-cin=%+8.3e \n",
                nref,
                freq,
                I_in[1],
                I_out[1],
...
function runtests()
    ...
    return @test result ≈ 0.5180855490694214
end


function create_plots()
    return main(plot_results = true, maxfreq = 200.0)
end
