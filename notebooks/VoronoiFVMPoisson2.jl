...
# ╔═╡ bef2d6d6-b676-4fd8-aee6-7f3137ab5322
...
\begin{aligned}
  -\nabla \cdot εε_0 \nabla \phi - q= 0\\
                                 q&=F\sum_{i=1}^n z_i \bar c y_i\\
Q&=\int_\Omega q d\omega
\end{aligned}
```
"""

# ╔═╡ b564e59d-96e4-47a6-9051-023be08432f1
md"""
In this version of the implementation, we introduce three species:
Electrostatic potential ``\phi``, charge density ``q`` and double layer charge ``Q``.
"""

# ╔═╡ 9e3a3229-6c31-4d46-8017-b0092c05d03e
begin
    const iφ = 1
    const iq = 2
    const iQ = 3
...
# ╔═╡ 448c5d0a-2c2d-4b5a-93c0-765543434a61
md"""
...
# ╔═╡ 12a0067a-89cd-4c9e-aeeb-6e947d112a8b
...
# ╔═╡ 8869dbf6-1e2f-464c-b2d1-2948c0d31bd6
VoronoiFVM.has_generic_operator(pbo_system)

# ╔═╡ 107b52fc-7d96-4487-b71c-61399f881faf
md"""
...
# ╔═╡ dae7e021-2a4d-4fce-97a0-c707e42767a1
pbo_sols[end]
...
# ╔═╡ 31ff055e-e94f-42cb-98a7-68e54052f57b
